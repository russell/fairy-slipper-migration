...
.. swagger:tag:: rescue
   :summary: Servers rescue and unrescue (servers, action)
...
.. swagger:tag:: server-start-stop
   :summary: Servers start and stop (servers, action)
...
.. swagger:tag:: disk-config
   :summary: Servers and images with disk config (servers, images)

   Extends servers with the ``diskConfig`` attribute.

.. swagger:tag:: availability-zone
   :summary: Servers availability zones (servers, os-availability-zone)

   Gets availability zone information.

.. swagger:tag:: instance-actions
   :summary: Servers instance actions (servers, os-instance-actions)
...
.. swagger:tag:: volume-attachments
   :summary: Servers with volume attachments (servers, os-volume_attachments)
...
.. swagger:tag:: os-volume_boot
   :summary: Server boot from volume (os-volumes_boot)
...
.. swagger:tag:: flavormanage
   :summary: Flavors create and delete (flavors)

   Creates, lists, and deletes flavors.

.. swagger:tag:: flv-disabled
   :summary: Flavors with disabled attribute (flavors)
...
.. swagger:tag:: flavor-rxtx
   :summary: Flavors with rxtx_factor extended attribute (flavors)
...
.. swagger:tag:: flavor-extra-specs
   :summary: Flavors with extra-specs (flavors, os-extra-specs)

   Lists, creates, and updates the extra-specs or keys for a flavor.

.. swagger:tag:: flavor-access
   :summary: Flavors access (flavors, os-flavor-access)
...
.. swagger:tag:: flavor-swap
   :summary: Flavors swap (flavors, os-flavor-swap)
...
.. swagger:tag:: ext-img-size
   :summary: Images with size attribute (images)
...
.. swagger:tag:: used-limits
   :summary: Limits with project usage (limits)
...
.. swagger:tag:: used-limits-for-admins
   :summary: Limits with project usage for administrators (limits)
...
.. swagger:tag:: aggregates
   :summary: Host aggregates (os-aggregates)
...
.. swagger:tag:: coverage
   :summary: Coverage reports (os-coverage)

   Shows coverage reports.

.. swagger:tag:: extended-networks
   :summary: Network extended attributes (os-extended-networks)
...
.. swagger:tag:: hypervisor-status
   :summary: Hypervisor with status (os-hypervisor-status)
