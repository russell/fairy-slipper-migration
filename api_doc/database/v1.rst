.. http:post:: /v1.0/{accountId}/instances/{instanceId}/root
   :synopsis: Enable root user

   Enables the root user for a specified database instance and returns
   the root password.
...
.. http:get:: /v1.0/{accountId}/instances/{instanceId}/root
   :synopsis: Show root-enabled status for database instance
...
.. http:delete:: /v1.0/{accountId}/instances/{instanceId}
   :synopsis: Delete database instance

   Deletes a specified database instance, including any associated
   data.
...
.. http:get:: /v1.0/{accountId}/instances/{instanceId}
   :synopsis: Show database instance details
...
.. http:get:: /v1.0/{accountId}/instances/{instanceId}
   :synopsis: List configuration defaults
...
.. http:put:: /v1.0/{accountId}/instances/{instanceId}
   :synopsis: Attach configuration group
...
.. http:put:: /v1.0/{accountId}/instances/{instanceId}
   :synopsis: Detach configuration group
...
.. http:get:: /v1.0/{accountId}/datastores/versions/{datastore_version_id}/parameters/{parameter_name}
   :synopsis: Show configuration parameter details

   Displays details for a configuration parameter associated with a
   specified datastore version.
...
.. http:post:: /v1.0/{accountId}/instances/{instanceId}/action
   :synopsis: Resize instance volume
...
.. http:post:: /v1.0/{accountId}/instances
   :synopsis: Create database instance
...
.. http:get:: /v1.0/{accountId}/instances
   :synopsis: List database instances
...
.. http:get:: /v1.0/{accountId}/instances/{instanceId}/users
   :synopsis: List database instance users
...
.. http:get:: /v1.0/{accountId}/datastores/{datastore_name}/versions
   :synopsis: List datastore versions
...
.. http:post:: /v1.0/{accountId}/configurations
   :synopsis: Create configuration group
...
.. http:get:: /v1.0/{accountId}/configurations
   :synopsis: List configuration groups
...
.. http:get:: /v1.0/{accountId}/datastores/versions/{datastore_version_id}/parameters
   :synopsis: List configuration parameters
...
.. http:get:: /v1.0/{accountId}/instances/{instanceId}/databases
   :synopsis: List instance databases
