...
.. http:put:: /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Assign role to group

   Assigns a specified role to a specified group on projects in a
   subtree.
...
.. http:head:: /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Check role for group

   Checks whether a specified group has a specified role assignment
   with the ``inherited_to_projects`` flag on a specified project.
...
.. http:delete:: /v3/OS-INHERIT/projects/{project_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Revoke role from group

   Revokes an inherited role from a specified group on a specified
   project.
...
.. http:get:: /v3/OS-OAUTH1/users/{user_id}/access_tokens/{access_token_id}
   :synopsis: Get authorized access token
...
.. http:delete:: /v3/OS-OAUTH1/users/{user_id}/access_tokens/{access_token_id}
   :synopsis: Revoke access token

   Enables a user to revoke an access token, which prevents the
   consumer from requesting new Identity Service API tokens. Also,
   revokes any Identity Service API tokens that were issued to the
...
.. http:post:: /v3/OS-OAUTH1/access_token
   :synopsis: Create access token

   Enables a consumer to create an access token by exchanging a
...
.. http:post:: /v3/auth/tokens
   :synopsis: Get an Identity Service token
...
.. http:put:: /v3/OS-INHERIT/projects/{project_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Assign role to user

   Assigns a specified role to a specified user on projects in a
   subtree.
...
.. http:head:: /v3/OS-INHERIT/projects/{project_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Check role for user

   Checks whether a specified user has a specified role assignment
   with the ``inherited_to_projects`` flag on a specified project.
...
.. http:delete:: /v3/OS-INHERIT/projects/{project_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Revoke role from user
...
.. http:get:: /v3/OS-OAUTH1/users/{user_id}/access_tokens
   :synopsis: List authorized access tokens
...
.. http:put:: /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Assign role to user owned by domain projects
...
.. http:head:: /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Check project role for user on domain

   Checks whether a specified user has an inherited project role on a
   specified domain.
...
.. http:delete:: /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Revoke project role from user on domain
...
.. http:post:: /v3/OS-OAUTH1/request_token
   :synopsis: Get unauthorized request token
...
.. http:put:: /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Assign role to group on domain projects

   Assigns a specified role to a specified group on projects owned by
   a specified domain.
...
.. http:head:: /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Check project role for group on domain

   Checks whether a specified group has an inherited project role on a
   specified domain.
...
.. http:delete:: /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/roles/{role_id}/inherited_to_projects
   :synopsis: Revoke project role from group on domain
...
.. http:post:: /v1/tickets
   :synopsis: Generate ticket

   Generates a ticket to facilitate messaging between a source and
   destination.
...
.. http:get:: /v3/OS-OAUTH1/users/{user_id}/access_tokens/{access_token_id}/roles
   :synopsis: List roles for an access token
...
.. http:get:: /v3/OS-OAUTH1/users/{user_id}/access_tokens/{access_token_id}/roles/{role_id}
   :synopsis: Get role information for an access token

   Gets information about a specified role for a specified access
   token.
...
.. http:get:: /v3/OS-INHERIT/domains/{domain_id}/groups/{group_id}/roles/inherited_to_projects
   :synopsis: List project roles for group on domain
...
.. http:get:: /v3/OS-INHERIT/domains/{domain_id}/users/{user_id}/roles/inherited_to_projects
   :synopsis: List project roles for user on domain
