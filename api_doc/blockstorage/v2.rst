.. http:get:: /v2/{tenant_id}/backups/detail
   ...
   :synopsis: Lists detailed information for backups defined in Block Storage to which the tenant who submits the request has access.
...
.. http:get:: /v2/{tenant_id}/snapshots/detail
   ...
   :synopsis: Lists detailed information for all Block Storage snapshots that the tenant who submits the request can access.
...
.. http:get:: /v2/{tenant_id}/qos-specs/{qos_id}/disassociate_all
   ...
   :synopsis: Disassociates a specified QoS specification from all associations.
...
.. http:post:: /v2/{tenant_id}/backups/{backup_id}/action
   ...
   :synopsis: Force-deletes a specified backup. Specify the ``os-force_delete`` action in the request body.
...
.. http:get:: /v2/{tenant_id}/backups/{backup_id}
   ...
   :synopsis: Shows details for a specified backup.
...
.. http:delete:: /v2/{tenant_id}/backups/{backup_id}
   :title: Delete backup
   :synopsis: Deletes a specified backup.
...
.. http:post:: /v2/{tenant_id}/snapshots
   ...
   :synopsis: Creates a snapshot, which is a point-in-time complete copy of a volume. You can create a volume from the snapshot.
...
.. http:get:: /v2/{tenant_id}/snapshots
   ...
   :synopsis: Lists summary information for all Block Storage snapshots that the tenant who submits the request can access.
...
.. http:get:: /v2/{tenant_id}/capabilities/{hostname}
   ...
   :synopsis: Shows capabilities for a specified storage back end.
...
.. http:get:: /v2/{tenant_id}/volumes/detail
   ...
   :synopsis: Lists detailed information for all Block Storage volumes that the tenant who submits the request can access.
...
.. http:post:: /v2/{tenant_id}/os-volume-manage
   ...
   :synopsis: Creates a Block Storage volume by using existing storage rather than allocating new storage.
...
.. http:get:: /v2/{tenant_id}/qos-specs/{qos_id}/associate
   ...
   :synopsis: Associates a QoS specification with a specified volume type.
...
.. http:post:: /v2/{tenant_id}/volumes
   ...
   :synopsis: Creates a private Block Storage volume.
...
.. http:get:: /v2/{tenant_id}/volumes
   :title: List volumes
   :synopsis: Lists summary information for all Block Storage volumes that the tenant who submits the request can access.
...
.. http:get:: /v2/{tenant_id}/os-vol-image-meta
   ...
   :synopsis: Shows image metadata that is associated with a specified volume.
...
.. http:get:: /v2
   ...
   :synopsis: Shows details for Block Storage API v2.
...
.. http:get:: /v2/{tenant_id}/qos-specs/{qos_id}
   ...
   :synopsis: Shows details for a specified QoS specification.
...
.. http:put:: /v2/{tenant_id}/qos-specs/{qos_id}
   ...
   :synopsis: Sets or unsets keys in a specified QoS specification.
...
.. http:delete:: /v2/{tenant_id}/qos-specs/{qos_id}
   ...
   :synopsis: Deletes a specified QoS specification.
...
.. http:get:: /v2/{tenant_id}/extensions
   ...
   :synopsis: Lists Block Storage API extensions.
...
.. http:get:: /v2/{tenant_id}/qos-specs/{qos_id}/associations
   ...
   :synopsis: Gets all associations for a specified QoS specification.
...
.. http:get:: /v2/{tenant_id}/qos-specs/{qos_id}/disassociate
   ...
   :synopsis: Disassociates a QoS specification from a specified volume type.
...
.. http:post:: /v2/{tenant_id}/backups/{backup_id}/restore
   ...
   :synopsis: Restores a Block Storage backup to an existing or new Block Storage volume.
...
.. http:post:: /v2/{tenant_id}/qos-specs
   ...
   :synopsis: Creates a QoS specification.
...
.. http:get:: /v2/{tenant_id}/qos-specs
   ...
   :synopsis: Lists quality of service (QoS) specifications.
...
.. http:post:: /v2/{tenant_id}/volumes/{volume_id}/action
   :title: Extend volume
   :synopsis: Extends the size of a specified volume to a new size requested in gibibytes (GiB). Specify the ``os-extend`` action in the request body.
...
.. http:post:: /v2/{tenant_id}/volumes/{volume_id}/action
   ...
   :synopsis: Resets the status, attach status, and migration status for a specified volume. Specify the ``os-reset_status`` action in the request body.
...
.. http:post:: /v2/{tenant_id}/volumes/{volume_id}/action
   ...
   :synopsis: Sets the image metadata for a specified volume. Specify the ``os-set_image_metadata`` action in the request body.
...
.. http:post:: /v2/{tenant_id}/volumes/{volume_id}/action
   ...
   :synopsis: Removes image metadata, by key, from a specified volume. Specify the ``os-unset_image_metadata`` action in the request body and the ``key`` for the metadata key and value pair that you want to remove.
...
.. http:post:: /v2/{tenant_id}/volumes/{volume_id}/action
   :title: Attach volume
   :synopsis: Attaches the specified volume to the specified server. Specify the ``os-attach`` action in the request body.
...
.. http:put:: /v2/{tenant_id}/snapshots/{snapshot_id}
   ...
   :synopsis: Updates a specified snapshot.
...
.. http:get:: /v2/{tenant_id}/limits
   ...
   :synopsis: Shows absolute limits for a tenant.
...
.. http:post:: /v2/{tenant_id}/backups
   :title: Create backup
   :synopsis: Creates a Block Storage backup from a volume.
...
.. http:get:: /v2/{tenant_id}/backups
   :title: List backups
   :synopsis: Lists backups defined in Block Storage to which the tenant who submits the request has access.
