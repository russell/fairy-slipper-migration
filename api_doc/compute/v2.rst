...
.. http:post:: //v2/{tenant_id}/servers/{server_id}/metadata
   :synopsis: Update server metadata items
...
.. http:put:: //v2/{tenant_id}/servers/{server_id}/metadata
   :synopsis: Create or replace server metadata items
...
.. http:get:: //v2/{tenant_id}/servers/{server_id}/ips/{network_label}
   :synopsis: List addresses by network
...
.. http:post:: //v2/{tenant_id}/servers/{server_id}/action
   ...
   Changes the password for a server. Specify the ``changePassword``
...
.. http:post:: //v2/{tenant_id}/servers/{server_id}/action
   :synopsis: Associate security          group with server

   Associates a specified security group with a server. Specify the
   ``security_group`` action and the name of the security group in the
   request body.
...
.. http:get:: //v2/{tenant_id}/flavors/detail
   :synopsis: List details for flavors
...
.. http:get:: //v2/{tenant_id}/servers/{server_id}/metadata/{key}
   :synopsis: Show server metadata item details
...
.. http:put:: //v2/{tenant_id}/servers/{server_id}/metadata/{key}
   :synopsis: Create or update server metadata item
...
.. http:delete:: //v2/{tenant_id}/servers/{server_id}/metadata/{key}
   :synopsis: Delete server metadata item
