.. http:put:: /v1/images/{image_id}/members/{owner_id}
   ...
   :requestexample: v1/examples/addMember-v1_req.txt
   :responseexample 404: v1/examples/addMember-v1_resp_404.txt
   :responseexample 204: v1/examples/addMember-v1_resp_204.txt
...
.. http:delete:: /v1/images/{image_id}/members/{owner_id}
   ...
   :requestexample: v1/examples/removeMember-v1_req.txt
   :responseexample 404: v1/examples/removeMember-v1_resp_404.txt
   :responseexample 204: v1/examples/removeMember-v1_resp_204.txt
   :tag: members
...
.. http:get:: /v1/shared-images/{owner_id}
   ...
   :requestexample: v1/examples/getSharedImages-v1_req.txt
   :responseexample 200: v1/examples/getSharedImages-v1_resp_200.txt
   :accepts: application/json
   :produces: application/json
   :tag: shared-images
   :parameter owner_id: Owner ID, which is the tenant ID.
...
.. http:post:: /v1/images
   ...
   :requestexample: v1/examples/createImage-v1_req.txt
   :responseexample 201: v1/examples/createImage-v1_resp_201.txt
   :responseexample 400: v1/examples/createImage-v1_resp_400.txt
   :tag: images
...
.. http:get:: /v1/images
   ...
   :requestexample: v1/examples/listImage-v1_req.txt
   :responseexample 200: v1/examples/listImage-v1_resp_200.txt
   :accepts: application/json
   :produces: application/json
   :tag: images
...
.. http:put:: /v1/images/{image_id}
   ...
   :requestexample: v1/examples/updateImage-v1_req.txt
   :responseexample 200: v1/examples/updateImage-v1_resp_200.txt
   :tag: images
   :parameter image_id: Image ID stored through the image API.
                        Typically a UUID.
   :statuscode 200: 
...
.. http:get:: /v1/images/{image_id}
   ...
   :requestexample: v1/examples/getImage-v1_req.txt
   :responseexample 200: v1/examples/getImage-v1_resp_200.txt
   :responseexample 404: v1/examples/getImage-v1_resp_404.txt
   :accepts: application/json
   :produces: application/json
   :tag: images
   :parameter image_id: Image ID stored through the image API.
...
.. http:delete:: /v1/images/{image_id}
   ...
   :requestexample: v1/examples/deleteImage-v1_req.txt
   :responseexample 200: v1/examples/deleteImage-v1_resp_200.txt
   :responseexample 404: v1/examples/deleteImage-v1_resp_404.txt
   :tag: images
   :parameter image_id: Image ID stored through the image API.
                        Typically a UUID.
   :statuscode 200: 
