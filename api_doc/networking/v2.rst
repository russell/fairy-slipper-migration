.. http:get:: /v2.0
   :synopsis: Show API v2.0 details
...
.. http:post:: /v2.0/subnets
   :synopsis: Bulk create subnet

   Creates multiple subnets in a single request. Specify a list of
   subnets in the request body.
...
.. http:post:: /v2.0/ports
   :synopsis: Bulk create ports

   Creates multiple ports in a single request. Specify a list of ports
   in the request body.
