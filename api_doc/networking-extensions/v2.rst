...
.. http:get:: /v2.0/floatingips
   ...
   and Column Selection <http://specs.openstack.org/openstack/neutron-
...
.. http:get:: /v2.0/security-group-rules/{rules-security-groups-id}
   ...
   :requestexample: v2/examples/getSecGroupRule_req.txt
...
.. http:delete:: /v2.0/security-group-rules/{rules-security-groups-id}
   ...
   :requestexample: v2/examples/deleteSecGroupRule_req.txt
   :responseexample 204: v2/examples/deleteSecGroupRule_resp_204.txt
   :tag: security_group-ruless
   :parameter rules-security-groups-id: The unique identifier of the
                                        security group rule.
   :statuscode 404: 
...
.. http:get:: /v2.0/metering/metering-labels
   ...
   :requestexample: v2/examples/listMeteringLabels_req.txt
...
.. http:get:: /v2.0/security-groups/{security_group_id}
   ...
   :requestexample: v2/examples/getSecGroup_req.txt
...
.. http:delete:: /v2.0/security-groups/{security_group_id}
   ...
   :requestexample: v2/examples/deleteSecGroup_req.txt
   :responseexample 204: v2/examples/deleteSecGroup_resp_204.txt
   :tag: security-groups
   :parameter security_group_id: The unique identifier of the security
                                 group.
   :statuscode 409: 
...
.. http:get:: /v2.0/security-groups
   ...
   :requestexample: v2/examples/listSecGroups_req.txt
...
.. http:get:: /v2.0/security-group-rules
   ...
   :requestexample: v2/examples/listSecGroupRules_req.txt
...
.. http:get:: /v2.0/metering/metering-label-rules
   ...
   :requestexample: v2/examples/listMeteringLabelRules_req.txt
...
.. http:get:: /v2.0/metering/metering-labels/{metering_label_id}
   ...
   :requestexample: v2/examples/getMeteringLabel_req.txt
...
.. http:delete:: /v2.0/metering/metering-labels/{metering_label_id}
   ...
   :requestexample: v2/examples/deleteMeteringLabel_req.txt
   :responseexample 204: v2/examples/deleteMeteringLabel_resp_204.txt
   :tag: metering
   :parameter metering_label_id: The unique identifier of the metering
                                 label.
   :statuscode 404: 
...
.. http:get:: /v2.0/metering/metering-label-rules/{metering-label-rule-id}
   ...
   :requestexample: v2/examples/getMeteringLabelRule_req.txt
...
.. http:delete:: /v2.0/metering/metering-label-rules/{metering-label-rule-id}
   ...
   :requestexample: v2/examples/deleteMeteringLabelRule_req.txt
   :responseexample 204: v2/examples/deleteMeteringLabelRule_resp_204.txt
   :tag: metering
   :parameter metering-label-rule-id: The unique identifier of
                                      metering label rule.
   :statuscode 404: 
